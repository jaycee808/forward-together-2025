    ...
    return (
        ...
        <div className="max-w-6xl w-full text-left">
            ...
            <div className="relative bg-gray-50 p-8 rounded-lg shadow-md">
                ...
                <ul className="list-disc list-inside space-y-4 font-inter text-base sm:text-lg md:text-xl text-gray-900">
            ...
            <div className="relative bg-gray-50 p-8 rounded-lg shadow-md">
                ...
                <p className="font-inter text-base sm:text-lg md:text-xl text-gray-900 mb-6">
